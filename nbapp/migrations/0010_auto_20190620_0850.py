# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2019-06-20 00:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nbapp.ClassList', verbose_name='班级')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, related_name='students', to='nbapp.ClassList', verbose_name='已报班级')),
                ('customer', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='nbapp.Customer', verbose_name='客户信息')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classstudyrecord', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nbapp.ClassStudyRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nbapp.Student', verbose_name='学员')),
            ],
        ),
        migrations.AlterField(
            model_name='permission',
            name='menu',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='nbapp.Menu'),
        ),
        migrations.AlterField(
            model_name='permission',
            name='pid',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='nbapp.Permission'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='dep',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='nbapp.Department'),
        ),
